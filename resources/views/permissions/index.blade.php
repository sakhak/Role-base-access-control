    ...
    <div class="min-h-screen bg-gray-50 p-6">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-8">
                <div>
                    <h1 class="text-2xl font-bold text-gray-800">Items Management</h1>
                    <p class="text-gray-600">Manage your application items</p>
                </div>
                <a 
                    href="" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach ($permissions as $permission)
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">{{ $permission->key??'' }}</div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <a href="{{ route('permission.show', $permission->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">Edit</a>
